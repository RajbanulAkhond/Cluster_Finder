#!/usr/bin/env python3
"""
Script to create a Jupyter notebook example for the cluster_finder package.
"""
...
with open('examples/example_usage.ipynb', 'w') as f:
    json.dump(notebook, f, indent=1)

print(f"Jupyter notebook created at examples/example_usage.ipynb") 